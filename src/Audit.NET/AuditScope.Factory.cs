...
namespace Audit.Core
{
    ...
    public partial class AuditScope
    {
        ...
        /// <param name="dataProvider">The data provider to use. NULL to use the configured default data provider.</param>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void CreateAndSave(string source, string eventType, object extraFields, AuditDataProvider dataProvider = null)
        {
            new AuditScope(new AuditScopeOptions(source, eventType, null, extraFields, dataProvider, null, true)).Start();
        }
        ...
        /// <param name="target">The reference object getter.</param>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static AuditScope Create(string source, string eventType, Func<object> target)
        {
            return new AuditScope(new AuditScopeOptions(source, eventType, target, null, null, null)).Start();
        }
        ...
        /// <param name="dataProvider">The data provider to use. NULL to use the configured default data provider.</param>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static AuditScope Create(string source, string eventType, Func<object> target, EventCreationPolicy creationPolicy, AuditDataProvider dataProvider = null)
        {
            return new AuditScope(new AuditScopeOptions(source, eventType, target, null, dataProvider, creationPolicy)).Start();
        }
        ...
        /// <param name="extraFields">An anonymous object that can contain additional fields to be merged into the audit event.</param>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static AuditScope Create(string source, string eventType, Func<object> target, object extraFields)
        {
            return new AuditScope(new AuditScopeOptions(source, eventType, target, extraFields, null, null)).Start();
        }
        ...
        /// <param name="skipExtraFrames">Used to indicate how many frames in the stack should be skipped to determine the calling method.</param>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static AuditScope Create(string source, string eventType, Func<object> target, object extraFields, EventCreationPolicy creationPolicy, AuditDataProvider dataProvider = null, AuditEvent auditEvent = null, int skipExtraFrames = 0)
        {
            return new AuditScope(new AuditScopeOptions(source, eventType, target, extraFields, dataProvider, creationPolicy, false, auditEvent, skipExtraFrames)).Start();
        }
        ...
        /// <param name="target">The reference object getter.</param>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static async Task<AuditScope> CreateAsync(string source, string eventType, Func<object> target)
        {
            return await new AuditScope(new AuditScopeOptions(source, eventType, target, null, null, null)).StartAsync();
        }
        ...
        /// <param name="dataProvider">The data provider to use. NULL to use the configured default data provider.</param>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static async Task<AuditScope> CreateAsync(string source, string eventType, Func<object> target, EventCreationPolicy creationPolicy, AuditDataProvider dataProvider = null)
        {
            return await new AuditScope(new AuditScopeOptions(source, eventType, target, null, dataProvider, creationPolicy)).StartAsync();
        }
        ...
        /// <param name="extraFields">An anonymous object that can contain additional fields to be merged into the audit event.</param>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static async Task<AuditScope> CreateAsync(string source, string eventType, Func<object> target, object extraFields)
        {
            return await new AuditScope(new AuditScopeOptions(source, eventType, target, extraFields, null, null)).StartAsync();
        }
        ...
        /// <param name="skipExtraFrames">Used to indicate how many frames in the stack should be skipped to determine the calling method.</param>
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static async Task<AuditScope> CreateAsync(string source, string eventType, Func<object> target, object extraFields, EventCreationPolicy creationPolicy, AuditDataProvider dataProvider = null, AuditEvent auditEvent = null, int skipExtraFrames = 0)
        {
            return await new AuditScope(new AuditScopeOptions(source, eventType, target, extraFields, dataProvider, creationPolicy, false, auditEvent, skipExtraFrames)).StartAsync();
        }
